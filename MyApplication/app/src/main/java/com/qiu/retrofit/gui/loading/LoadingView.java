package com.qiu.retrofit.gui.loading;
...
import com.qiu.retrofit.util.NetUtils;
...
public class LoadingView extends FrameLayout implements OnClickListener {
	...
	public IRetryListener mOnRetryListener;

	public LoadingView withOnRetryListener(IRetryListener mOnRetryListener) {
